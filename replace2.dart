...
class LedgerEntry {''');
  ...
  // 1. VaultSettings updates
  text = text.replaceFirst('required this.xianyuEnabled,\n  });', 'required this.xianyuEnabled,\n    this.locationMode = LocationTrackingMode.off,\n  });');
...
''';
  ...
  // 9. InsightsScreen Visualizations
